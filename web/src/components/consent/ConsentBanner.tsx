...
export default function ConsentBanner() {
  ...
  return (
    <div
      role="region"
      aria-label={t('title')}
      className="fixed inset-x-0 bottom-0 z-[70] border-t border-line bg-pure px-5 py-4 shadow-[0_-12px_32px_-16px_rgba(0,0,0,0.25)] print:hidden"
    >
      <div className="mx-auto flex max-w-shell flex-wrap items-center gap-4">
        ...
        <div className="flex flex-none flex-wrap gap-3">
          <button
            ...
            className="min-h-[44px] rounded border border-line px-4 text-sm font-semibold text-graphite hover:border-machine"
          >
            {t('reject')}
          </button>
          <button
