  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-pure">
      <div className="mx-auto flex min-h-[88px] max-w-shell items-center gap-6 px-[clamp(20px,4.5vw,72px)] py-4">
        <Link href="/" className="flex flex-none items-center font-extrabold tracking-tight" aria-label={t('brand')}>
          <span className="text-lg">SOFTEC</span>
          <span className="ms-1 text-lg text-softec">VISION</span>
        </Link>
